...
//        String USER = "Ioana";
        ...
        Repository<User> userFileRepo = new InFileRepository<User>("C:\\Users\\" + USER +"\\IdeaProjects\\StarMatch\\starmatch\\src\\files\\users.txt", User.class);
        Repository<Admin> adminFileRepo = new InFileRepository<Admin>("C:\\Users\\"+ USER + "\\IdeaProjects\\StarMatch\\starmatch\\src\\files\\admins.txt", Admin.class);
        Repository<StarSign> starSignFileRepo = new InFileRepository<StarSign>("C:\\Users\\" + USER + "\\IdeaProjects\\StarMatch\\starmatch\\src\\files\\starsigns.txt", StarSign.class);
        Repository<Quote> quoteFileRepo = new InFileRepository<Quote>("C:\\Users\\" + USER + "\\IdeaProjects\\StarMatch\\starmatch\\src\\files\\quotes.txt", Quote.class);
        Repository<Trait> traitFileRepo = new InFileRepository<Trait>("C:\\Users\\" + USER + "\\IdeaProjects\\StarMatch\\starmatch\\src\\files\\traits.txt", Trait.class);
